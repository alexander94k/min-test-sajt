...
function fixMobileAlignment() {
  ...
  for (const slug of pagesToFix) {
    ...
    @media (max-width: 767px) {
      ...
      /* Remove auto margins that center content - target all divs */
      .section-inner div,
      .dark-bg div,
      section div {
      ...
      /* Ensure no element is centered */
      * {
        margin-left: 0 !important;
        margin-right: 0 !important;
      }

      /* Restore normal padding for specific elements that need it */
      .section-inner,
      article,
      section {
        margin: 0 !important;
      ...
      /* Feature icons - left align everything including SVG */
      .feature-icon {
        text-align: left !important;
        display: flex;
      ...
      /* All SVG icons left aligned on mobile */
